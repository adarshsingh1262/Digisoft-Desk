...
export const ANALYTICS_QUEUE_TOKEN = Symbol('ANALYTICS_QUEUE');
...
@Module({
  providers: [
    ...
    {
      provide: ANALYTICS_QUEUE_TOKEN,
      inject: [REDIS_CLIENT],
      useFactory: queueFactory(QUEUE_NAMES.ANALYTICS),
    },
  ],
  exports: [
    EMAIL_QUEUE,
